...
%\usepackage[latin1]{inputenc} % Eingabekodierung festlegen (hier: ISO 8859-1)
                              % (Umlaute koennen so direkt eingegeben werden)  
                              % ACHTUNG: wenn man UTF-8 verwendet, folgende Zeile nutzen:
